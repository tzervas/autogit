...
**Status**: [Proposed | Accepted | Deprecated | Superseded] **Date**: YYYY-MM-DD **Deciders**:
\[List of people involved\] **Technical Story**: [Link to issue/epic]
...
1. **Fill in all sections**: Don't leave sections empty
1. **Update this index**: Add your ADR to the table above
1. **Link related ADRs**: Cross-reference related decisions
1. **Get review**: Have the team review before marking as "Accepted"
...
1. **Document alternatives**: Show what you didn't choose and why
1. **Link resources**: Include research and references
1. **Update promptly**: Write ADRs when decisions are made, not after

## Resources

- [ADR GitHub Organization](https://adr.github.io/)
- [Documenting Architecture Decisions](https://cognitect.com/blog/2011/11/15/documenting-architecture-decisions)
- [ADR Tools](https://github.com/npryce/adr-tools) --**Last Updated**: 2025-12-21 **Maintainer**:
  Project Team
