...
- **Development standards** with real code examples
- **Documentation Update Checklist** - 10+ items to verify
...
- **Documentation IS code** - Same commit, same rigor
- **INDEX.md is source of truth** - All docs mapped
- **ADRs required** - All architecture decisions tracked
