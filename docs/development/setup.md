...
1. Check out [Common Tasks](common-tasks.md)
1. Browse the [Architecture documentation](../architecture/README.md)
1. Join the [development discussion](https://github.com/yourusername/autogit/discussions)
...
**Documentation Version**: 1.0.0 **Last Updated**: YYYY-MM-DD **Related Docs**:
[Development Overview](README.md) | [Standards](standards.md) | [Testing](testing.md)
