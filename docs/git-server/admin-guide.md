...
This guide provides instructions for administrators to manage the AutoGit Git Server (GitLab CE). It covers user management, system maintenance, and monitoring.
...
2. Click **New user**.
3. Fill in the details and click **Create user**.
...
2. Pull the new image: `docker compose pull git-server`.
3. Restart the service: `docker compose up -d git-server`.
...
## Security Audits
Regularly check the **Admin Area** > **Monitoring** > **Audit Events** to track sensitive actions across the platform.
