...
**Focus**: Developer Workflow and Usage
...
3. See the [SSH Access Guide](ssh-access.md) for detailed instructions.

### Personal Access Tokens
For API access or using Git over HTTP, create a Personal Access Token (PAT).
1. Go to **User Settings** > **Access Tokens**.
2. Select scopes (e.g., `api`, `read_repository`, `write_repository`).
...
3. Set the visibility to **Private** (recommended).
...
2. Go to the project page and click **Create merge request**.
3. Assign reviewers and describe your changes.

### Issues and Labels
Use the **Issues** sidebar to track tasks, bugs, and feature requests. Use **Labels** to categorize and prioritize work.
...
## Support
For issues or questions, please contact your system administrator or refer to the [official GitLab documentation](https://docs.gitlab.com/).
