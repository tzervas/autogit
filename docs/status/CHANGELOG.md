...
### Added
- **Project Reorganization**: Cleaned up root directory and moved documentation to `docs/` subdirectories.
- **Automated Versioning**: Implemented `scripts/automate-version.sh` and GitHub Actions workflow for semantic versioning.
- **Homelab Infrastructure**: Added Terraform/OpenTofu configuration for deployment to homelab server (192.168.1.170).
