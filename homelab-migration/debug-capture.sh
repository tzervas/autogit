...
echo "   Memory usage:" > "$LOG_DIR/system-resources.txt"
free -h >> "$LOG_DIR/system-resources.txt" 2>&1
echo "" >> "$LOG_DIR/system-resources.txt"
echo "   Disk usage:" >> "$LOG_DIR/system-resources.txt"
df -h . >> "$LOG_DIR/system-resources.txt" 2>&1
